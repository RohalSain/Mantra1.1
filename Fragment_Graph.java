...
public class Fragment_Graph extends Fragment {
    ...
    private ArrayList<ILineDataSet> setXAxisValues(){
        ArrayList<ILineDataSet> xVals = new ArrayList<>();
        xVals.add(ILineDataSet) "10");
        xVals.add("10");
        xVals.add("20");
        xVals.add("30");
        xVals.add("30.5");
    ...
    private void setData() {
        ArrayList<ILineDataSet> xVals = setXAxisValues();
